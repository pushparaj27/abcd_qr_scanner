...
import 'package:my_example/second_screen.dart';
...
class _HomePageState extends State<HomePage> with WidgetsBindingObserver {
  ...
  void _handleResultListener() {
    if (_controller?.result != _result) {
       Navigator.push(
    context,
    MaterialPageRoute(builder: (context) =>  SecondScreen(text: _controller!.result!.text!,)),
  );
        ...
        child: Center(
          child: Container(
            ...
            child: Row(
              ...
              children: <Widget>[
                _buildToolBarButton('qr code', _scanType == BarcodeScanType.qrCode,
                ...
                _buildToolBarButton('bar code', _scanType == BarcodeScanType.barCode,
